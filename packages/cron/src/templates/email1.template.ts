...
<table class="s-2 w-100" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    ...
    <p style="line-height: 24px; font-size: 15px; margin: 14px 12px 14px 12px;"><b><span style="text-decoration:underline; text-decoration-thickness:1px;">YES, I want to connect with WorkBC.</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></p>
    </a>
