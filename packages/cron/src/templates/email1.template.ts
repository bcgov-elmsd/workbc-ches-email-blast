  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 15px; width: 100%; margin: 0; padding: 0px 20px 0px 20px;">
        <div>          
          <div style="text-align:center; height:120px"><img src="${process.env.IMAGES}public-static/workbc/workbc-logo.png" alt="WorkBC Employment Services" style="height:auto; width:250px"></div>
