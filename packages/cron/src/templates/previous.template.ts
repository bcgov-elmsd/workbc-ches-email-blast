/**
 * @description Fill in the "Past WorkBC Client Email" email template with tailored information
...
<title>Reonnect with WorkBC Employment Services</title>
</head>
...
<p style="line-height: 24px; font-size: 15px; margin: 0;">You are receiving this email because you recently applied for Employment Insurance (EI).</p>
<table class="s-3 w-100" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;">
...
<p style="line-height: 24px; font-size: 15px; margin: 0;">We wanted to invite you to reconnect with WorkBC, a free employment service to support you in your job search.</p>
<table class="s-3 w-100" cellpadding="0" cellspacing="0" style="width: 100%;">
  <tbody>
    <tr>
      <td height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;">
      ...
      <tr style="line-height:24px; font-size:15px;">
        ...
        <td valign="top" width="250" style="max-width:250px; background-color:#38598a; border-radius: 12px;"> 
          ...
          <a width="250" height="76" href="${form}" style="text-decoration-thickness:3px; text-decoration-color:#38598a; color: white; display:block; padding: 14px 12px 14px 12px;">
            <b>YES, I want to reconnect with WorkBC.</b>
          </a>
          <!--[if mso]>
            </center>
            </v:roundrect>
