...
const Form = () => {
    const centres = [
        { name: "Centre 1", email: "trista.dhami@gov.bc.ca" },
        { name: "Centre 2", email: "brian.d.pham@gov.bc.ca" },
        { name: "Centre 3", email: "phamdinhnguyen338@gmail.com" },
        { name: "Centre 4", email: "nguyenphamswork@gmail.com" },
        { name: "Centre 5", email: "t.dhami.9@outlook.com" },
        { name: "Centre 6", email: "triceratop43@gmail.com" },
        { name: "Centre 7", email: "trista@dhami.com" }
    ]
    return (
            ...
            <form className="form-group">
                ...
                <div className="tw-mt-6">
                    <label htmlFor="location" className="font-weight-bold tw-block">
                        ...
                        <select id="location" className="custom-select" defaultValue="trista.dhami@gov.bc.ca">
                            {centres.map((c) => (
